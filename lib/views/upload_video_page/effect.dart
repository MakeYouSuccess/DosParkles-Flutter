...
Effect<UploadVideoState> buildEffect() {
  return combineEffects(<Object, Effect<UploadVideoState>>{
...
void _onInit(Action action, Context<UploadVideoState> ctx) async {
...
void _onBuild(Action action, Context<UploadVideoState> ctx) {}

void _onDispose(Action action, Context<UploadVideoState> ctx) {}

void _onAction(Action action, Context<UploadVideoState> ctx) {}
