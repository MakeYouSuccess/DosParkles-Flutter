...
import 'package:com.floridainc.dosparkles/widgets/branch/next_screen.dart';
import 'package:com.floridainc.dosparkles/widgets/branch/utils/dialog_utils.dart';
...
class _HomeScreenState extends State<HomeScreen> {
  ...
  void _generateDeepLink(BuildContext context) async {
    ...
    if (response.success) {
      ...
      ToastUtils.displayToast("${response.result}", context);
    } else {
      ConsoleLogUtils.printLog(
